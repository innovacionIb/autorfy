...
public class VideoPlaybackBehaviour : MonoBehaviour
{
	...
	public VideoPlayerHelper mVideoPlayer = null;
    ...
    void Start()
    {
        ...
        mIconPlane = transform.Find("Video").gameObject;
        ...
        else if (!mIsPrepared)
        {
            ...
            else if (state < VideoPlayerHelper.MediaState.NOT_READY)
            {
                ...
                if (isPlayableOnTexture)
                {
                    ...
                    int nativeTextureID = (int)mVideoTexture.GetNativeTexturePtr();
    ...
    public void HandleStateChange(VideoPlayerHelper.MediaState newState)
    {
